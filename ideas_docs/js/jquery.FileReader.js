(function( $ ){
	...
	*/
	$.fn.fileReader.defaults = {
		...
		label           : null,
		extensions      : null,
		filereader      : 'js/filereader.swf', // The path to the filereader swf file
		expressInstall  : 'js/swfobject/expressinstall.swf', // The path to the express install swf file
		debugMode       : false,
		callback        : null // Callback function when Filereader is ready
	};
